...
An interactive, browser-based dashboard for comparing **self-reported** and **objective** social media use data. Upload your dataset, review AI-assisted column mapping, handle missing values, and explore bias patterns across participants and demographic groups — all without any backend infrastructure.
